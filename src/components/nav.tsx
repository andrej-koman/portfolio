...
export default function Nav() {
  ...
  return (
    <nav className="grid h-[50px] grid-cols-2 rounded-tr-base border-b-4 border-b-black bg-black text-xl w600:text-lg w400:h-10 w400:text-base portrait:rounded-none">
      <Link
        className={clsx(
